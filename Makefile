...
INSTALLARCHLIB = /usr/lib/perl5/5.8.0/i586-linux-thread-multi
DESTINSTALLARCHLIB = $(DESTDIR)$(INSTALLARCHLIB)
INSTALLSITEARCH = /usr/lib/perl5/site_perl/5.8.0/i586-linux-thread-multi
...
DISTVNAME = WWW-Google-News-0.07
...
manifypods : pure_all  \
	...
	$(NOECHO) $(POD2MAN) --section=3 --perm_rw=$(PERM_RW) \
	  News.pm $(INST_MAN3DIR)/WWW::Google::News.$(MAN3EXT) 
...
realclean purge ::  clean realclean_subdirs
	...
	$(RM_RF) $(DISTVNAME)
	$(RM_RF)  $(MAKEFILE_OLD) $(FIRST_MAKEFILE) $(INST_LIB)/WWW/Google/News.pm
...
metafile :
	...
	$(NOECHO) $(ECHO) 'name:         WWW-Google-News' >> META_new.yml
	$(NOECHO) $(ECHO) 'version:      0.07' >> META_new.yml
	$(NOECHO) $(ECHO) 'version_from: News.pm' >> META_new.yml
...
ppd:
	...
	$(NOECHO) $(ECHO) '    <AUTHOR>Greg McCarroll &lt;greg@mccarroll.demon.co.uk&gt;</AUTHOR>' >> $(DISTNAME).ppd
...
pm_to_blib.ts: $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', '\''$(PM_FILTER)'\'')' \
	  News.pm $(INST_LIB)/WWW/Google/News.pm 
	$(NOECHO) $(TOUCH) $@
