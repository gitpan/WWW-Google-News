# This Makefile is for the WWW::Google::News extension to perl.
#
...
#
#   MakeMaker ARGV: (q[PREFIX=/var/www/cgi-bin/lib/], q[LIB=/var/www/cgi-bin/lib/])
#
#   MakeMaker Parameters:

#	AUTHOR => q[Greg McCarroll <greg@mccarroll.demon.co.uk>]
#	NAME => q[WWW::Google::News]
...
DISTNAME = WWW-Google-News
NAME_SYM = WWW_Google_News
VERSION = 0.04
VERSION_SYM = 0_04
XS_VERSION = 0.04
INST_BIN = blib/bin
...
PREFIX = /var/www/cgi-bin/lib/
SITEPREFIX = $(PREFIX)
VENDORPREFIX = $(PREFIX)
INSTALLDIRS = site
INSTALLPRIVLIB = /var/www/cgi-bin/lib/
INSTALLARCHLIB = /var/www/cgi-bin/lib/i386-linux
INSTALLSITELIB = /var/www/cgi-bin/lib/
INSTALLSITEARCH = /var/www/cgi-bin/lib/i386-linux
...
FULLEXT = WWW/Google/News
BASEEXT = News
PARENT_NAME = WWW::Google
DLBASE = $(BASEEXT)
...
# Where to put things:
INST_LIBDIR      = $(INST_LIB)/WWW/Google
INST_ARCHLIBDIR  = $(INST_ARCHLIB)/WWW/Google
...
manifypods : pure_all News.pm
	@$(POD2MAN) \
	News.pm \
	$(INST_MAN3DIR)/WWW::Google::News.$(MAN3EXT)
...
Makefile : Makefile.PL $(CONFIGDEP)
	...
	$(PERL) "-I$(PERL_ARCHLIB)" "-I$(PERL_LIB)" Makefile.PL "PREFIX=/var/www/cgi-bin/lib/" "LIB=/var/www/cgi-bin/lib/"
...
ppd:
	@$(PERL) -e "print qq{<SOFTPKG NAME=\"WWW-Google-News\" VERSION=\"0,04,0,0\">\n}. qq{\t<TITLE>WWW-Google-News</TITLE>\n}. qq{\t<ABSTRACT></ABSTRACT>\n}. qq{\t<AUTHOR>Greg McCarroll &lt;greg\@mccarroll.demon.co.uk&gt;</AUTHOR>\n}. qq{\t<IMPLEMENTATION>\n}. qq{\t\t<DEPENDENCY NAME=\"Test-More\" VERSION=\"0,0,0,0\" />\n}. qq{\t\t<OS NAME=\"$(OSNAME)\" />\n}. qq{\t\t<ARCHITECTURE NAME=\"i386-linux\" />\n}. qq{\t\t<CODEBASE HREF=\"\" />\n}. qq{\t</IMPLEMENTATION>\n}. qq{</SOFTPKG>\n}" > WWW-Google-News.ppd
